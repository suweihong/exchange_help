    ...
    <div class="tpl-portlet-components"  > 
     <div class="portlet-title"  > 
      <div class="caption font-green bold"> 
       <span class="am-icon-code"> 添加文章</span>
      </div> 
       ...
       <div class="am-g"> 
        <div class="tpl-form-body tpl-form-line"> 
         <form class="am-form tpl-form-line-form"> 
          ...
          <div class="am-form-group"> 
           <label for="user-intro" class="am-u-sm-3 am-form-label">文章内容<span class="tpl-form-line-small-title">Content</span></label> </label> 
           <div class="am-u-sm-9"> 
  ...
  <script type="text/javascript">
          ...
          var suoimg = '';
            ...
            if(title==""){
                ...
                $.post("{{url('/admin/addarticle')}}",{'_token':'{{csrf_token()}}','title':title,'bankuai':bankuai,'content':content,'img':suoimg,'recommend':recommend},function(res){
          if(res){
            layer.msg('添加成功');
